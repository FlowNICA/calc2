...
//
void dv1dy_mpd_fxt_pT(){
  std::pair<float, float> proton_cent_cut  = {10., 40.};
  auto file = TFile::Open("/run/media/peter/ssd4tb/Work/Dataset/QnToolsMPD/files-prod40/calc_urqmd_xew_2.5agev_prod40.root");
  auto file_out = TFile::Open( "/run/media/peter/ssd4tb/Work/Dataset/QnToolsMPD/files-prod40/dv1dypT_urqmd_xew_2.5agev_prod40.root", "recreate" );
  ...
  v1_proton.Rebin( std::vector{ Qn::AxisD{"cent", 1, proton_cent_cut.first, proton_cent_cut.second }, 
    Qn::AxisD{"tr_y", 6, -1.1, 0.1 },
    Qn::AxisD{"tr_pT", {0.4, 0.8, 1.2, 1.6, 2.}} } );
  v1_proton.Project( std::vector{ "tr_y"s, "tr_pT"s } );

  auto fitter = Fitter( v1_proton, "tr_y"s, "tr_pT"s );
